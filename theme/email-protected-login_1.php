...
<div id="login">
	...
	<form name="loginform" id="loginform" action="<?php echo esc_url( $Email_Protected->login_url() ); ?>" method="post">
		<p>
...
<script type="text/javascript">
try{document.getElementById('email_protected_email_field').focus();}catch(e){}
